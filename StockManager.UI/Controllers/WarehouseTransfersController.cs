...
namespace StockManager.UI.Controllers
{
    public class WarehouseTransfersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("WarehouseTransferID,Reference,TransferDate,FromWarehouseRef,ToWarehouseRef,TotalGarmentsQtyOut,TotalGarmentsQtyIn,TotalBoxesQtyOut,TotalBoxesQtyIn,TotalUnitsQtyOut,TotalUnitsQtyIn,CreatedBy,CreatedDate")] WarehouseTransfers warehouseTransfers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WarehouseTransferID,Reference,TransferDate,FromWarehouseRef,ToWarehouseRef,TotalGarmentsQtyOut,TotalGarmentsQtyIn,TotalBoxesQtyOut,TotalBoxesQtyIn,TotalUnitsQtyOut,TotalUnitsQtyIn,CreatedBy,CreatedDate")] WarehouseTransfers warehouseTransfers)
        {
